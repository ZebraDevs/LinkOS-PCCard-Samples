...
namespace CSharpContactlessSmartCardSample
{
    public class ZBRPrinter
    {
        ...
        *           
        * 
        * Parameters:  cardType = int containing Contactless or Contactlessless card type
        *              errValue = int containing the error code if error encountered
        *                 
        * Returns: 1 = success
        *          0 = failed 
        ...
        * Date             Who             Comment
        * 08/01/2011       ACT             Function creation.
		* 10/13/2015	   SRP			   Change SDK call to start encoding properly.
        ***************************************************************************************************/
        ...
        * Date             Who             Comment
        * 08/01/2011       ACT             Function creation.
        * 10/13/2015       SRP             Change SDK call to end encoding properly.
        ***************************************************************************************************/

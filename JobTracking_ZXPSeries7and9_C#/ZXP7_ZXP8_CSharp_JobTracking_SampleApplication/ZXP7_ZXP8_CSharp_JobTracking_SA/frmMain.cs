    ...
    public partial class frmMain : Form
    {
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                PerformPrintTest(ref zxp, "Job Tracking", cboCardType.Text);
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                switch (test)
                {
                    case "Job Tracking":
                        ...
                        zxp.Perform_PrintJob_To_Be_Tracked(cardType, ref job, out actionID);
                        
                        zxp.TrackJobToCompletionOrError(ref job, actionID, out status);

                        if (!string.IsNullOrEmpty(status))
                            MessageBox.Show(status, "Job Result");
                        break;
                }
            }
            catch (Exception ex)

...
namespace ZXP7_ZXP8_CSharp_JobTracking_SA
{
    class ZXPSampleCode
    {
        #region Declarations
        ...
        public bool Perform_PrintJob_To_Be_Tracked(string cardType, ref Job job, out int actionID)
        {
            actionID = 0;
            ...
            try
            {
                ...
                g.DrawTextString(50.0f, 580.0f, "Color + MonoK Panel Print", "Arial", 10.0f,
        ...
        public void TrackJobToCompletionOrError(ref Job job, int actionID, out string status)
        {
            status = string.Empty;
